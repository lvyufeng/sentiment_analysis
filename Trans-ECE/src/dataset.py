...
def PrintMsg(total_batch, emo_metric, cse_metric, pr_metric):
    emo_msg = 'total batch: {}, emo pre: {:.4f}, emo rec: {:.4f}, emo f1: {:.4f}, emo acc: {:.4f}'.format(
        total_batch, emo_metric[0], emo_metric[1], emo_metric[2], emo_metric[3])
    cse_msg = 'total batch: {}, cse pre: {:.4f}, cse rec: {:.4f}, cse f1: {:.4f}, cse acc: {:.4f}'.format(
        total_batch, cse_metric[0], cse_metric[1], cse_metric[2], cse_metric[3])
    pr_msg = 'total batch: {}, pr pre: {:.4f}, pr rec: {:.4f}, pr f1: {:.4f}'.format(
        total_batch, pr_metric[0], pr_metric[1], pr_metric[2])
    print(emo_msg + '\n' + cse_msg + '\n' + pr_msg)
